  ...
  return (
    <div className="flex flex-col gap-2 p-3">
      ...
      <div
        ...
        className="flex flex-col gap-2 outline-none focus-visible:ring-2 focus-visible:ring-emerald-600/40 rounded-xl"
      >
        {filteredRoutes.map((route, index) => {
          ...
          return (
            <article
              ...
              className={`vm-card rounded-2xl border p-3 outline-none ${
