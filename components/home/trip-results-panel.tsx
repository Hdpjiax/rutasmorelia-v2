...
export function TripResultsPanel({
  ...
  return (
    <div data-testid="trip-planner-results" className="flex flex-col gap-2.5 p-3">
      {geocodeDegraded && (
        <p
          className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-[11px] font-medium text-amber-900"
          role="status"
        >
      ...
      {planning && (
        <div
          className="flex flex-col gap-1.5 rounded-xl bg-slate-50 px-3 py-4 text-sm text-slate-700"
          role="status"
          aria-live="polite"
        >
        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-1.5" role="group" aria-label="Ordenar por">
            ...
            {(
              ...
              <button
                ...
                className={`rounded-full border px-2 py-0.5 text-[10px] font-bold cursor-pointer ${
                  planSort === s.id
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={onShare}
              className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-white py-2 text-[11px] font-bold text-slate-800 cursor-pointer hover:bg-slate-50"
            >
