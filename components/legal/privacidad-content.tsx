...
export const PRIVACIDAD_UPDATED = '11 de julio de 2026';

type Props = {
  /** En modal in-app: callback en lugar de <a href> */
  onOpenTerminos?: () => void;
};

/**
 * Cuerpo de la política de privacidad (reutilizado en /privacidad y en el sheet de la app).
 */
export function PrivacidadContent({ onOpenTerminos }: Props) {
  return (
    <article className="max-w-none text-slate-700">
      <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">
        Política de privacidad
      </h1>
      <p className="text-sm text-slate-500">Última actualización: {PRIVACIDAD_UPDATED}</p>
      ...
      <p className="mt-10 text-sm text-slate-600">
        ...
        {onOpenTerminos ? (
          ...
          <a href="/terminos" className="font-semibold text-emerald-700 underline">
            términos de uso
          </a>
        )}
        .
